...
- 🌱 I’m currently learning ML methods for causal inference, the [NIMBLE environment for R](https://r-nimble.org/) for MCMC, and [Google Earth Engine](https://earthengine.google.com/).
